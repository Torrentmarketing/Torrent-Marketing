...
export function CinematicHero({ 
  ...
  tagline1 = "Expand your Pharma Network,",
  tagline2 = "with Digital Precision.",
  cardHeading = "Marketing, redefined.",
  cardDescription = <><span className="text-white font-semibold">Torrent Pharma</span> connects manufacturers with serious franchisers and distributors across Pakistan using verified digital lead generation.</>,
  metricValue = 1250,
  metricLabel = "Verified Leads",
  ctaHeading = "Scale your brand.",
  ctaDescription = "Join Pakistan's fastest growing pharma network and fill your uncovered territories in record time.",
  className, 
  ...props 
}: CinematicHeroProps) {
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Campaign</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">TP</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Growth Spurt</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Network expanding</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Distributor Verified</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Ready to close</p>
                  </div>
                </div>
